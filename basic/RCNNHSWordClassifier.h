/*
 * RCNNHSWordClassifier.h
 *
 *  Created on: Mar 18, 2015
 *      Author: mszhang
 */

#ifndef SRC_RCNNHSWordClassifier_H_
#define SRC_RCNNHSWordClassifier_H_
...
class RCNNHSWordClassifier {
public:
	RCNNHSWordClassifier() {
		_dropOut = 0.5;
	}
	~RCNNHSWordClassifier() {
...
#endif /* SRC_RCNNHSWordClassifier_H_ */
