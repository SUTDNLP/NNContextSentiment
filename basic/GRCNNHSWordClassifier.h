/*
 * GRCNNHSWordClassifier.h
 *
 *  Created on: Mar 18, 2015
 *      Author: mszhang
 */

#ifndef SRC_GRCNNHSWordClassifier_H_
#define SRC_GRCNNHSWordClassifier_H_
...
class GRCNNHSWordClassifier {
public:
	GRCNNHSWordClassifier() {
		_dropOut = 0.5;
	}
	~GRCNNHSWordClassifier() {
...
#endif /* SRC_GRCNNHSWordClassifier_H_ */
